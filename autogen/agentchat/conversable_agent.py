...
class ConversableAgent(LLMAgent):
    ...
    def _process_message_before_send(
        ...
        hook_list = self.hook_lists["process_message_before_send"] #hook_list=[]
        #import pdb
        #pdb.set_trace()
    ...
    def send(
        ...
        valid = self._append_oai_message(message, "assistant", recipient) #self._oai_messages[recipient]
        if valid:
